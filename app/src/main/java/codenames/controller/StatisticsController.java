...
public class StatisticsController {
    @FXML private Label blueAverageTimeLabel;
    @FXML private Label blueAverageCardsLabel;
    @FXML private Label blueNumberOfErrorsLabel;
    @FXML private Label blueNumberOfGuessLabel;
    @FXML private Label blueNumberOfTurnsLabel;
    @FXML private Label blueRemainingCardsLabel;

    @FXML private Label redAverageTimeLabel;
    @FXML private Label redAverageCardsLabel;
    @FXML private Label redNumberOfErrorsLabel;
    @FXML private Label redNumberOfGuessLabel;
    @FXML private Label redNumberOfTurnsLabel;
    @FXML private Label redRemainingCardsLabel;
